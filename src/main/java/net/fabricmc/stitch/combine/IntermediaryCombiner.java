...
public class IntermediaryCombiner {
    ...
    private Map<String, ClassEntry> clientIntermediary = new HashMap<>();
    private Map<String, ClassEntry> serverIntermediary = new HashMap<>();
    ...
    public void writeCombined(ClassWriter clsw, FieldWriter fldw, MethodWriter mtdw) throws IOException {
        Map<String, ClassEntry> invertedClient = new HashMap<>();
        Map<String, ClassEntry> invertedServer = new HashMap<>();
